...
public class DeallocateRoomMenu extends JFrame {

	private JPanel contentPane;


	public DeallocateRoomMenu(Library l,String librarian_Name) {
		...
		JButton btnAddNBook = new JButton("Dealloacte Room");
		btnAddNBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try 
				{
					...
					deallocate_Room(l,librarian_Name,RoomNo);
				} 
	...
	public void deallocate_Room(Library l,String librarian_Name,int RoomNo)
	{
		...
		if(flag1==1)
		{
			JOptionPane.showMessageDialog(new JFrame(), "Room deallocated sucessfully");
			dispose();
			new LibrarianMenu(l,librarian_Name);
		}
		else if (flag2==1)
		{
			JOptionPane.showMessageDialog(new JFrame(), "Room is not allocated to anyone.");
			dispose();
			new LibrarianMenu(l,librarian_Name);
		}
		else if(flag2==0)
