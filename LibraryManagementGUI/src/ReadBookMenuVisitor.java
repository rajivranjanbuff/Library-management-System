...
public class ReadBookMenuVisitor extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
	int found=0,read=0;
	
	public ReadBookMenuVisitor(Library l, String memberName) {
		...
		btnNext.addActionListener(new ActionListener() {
			...
			if(flag1==1&& flag3==1)
			read_Book(l,Book_Name,Category,memberName);
			
		}
	});
	
	}
	public void read_Book(Library l,String Book_Name,String Category,String memberName)
	{
		...
		{
			dispose();
			JOptionPane.showMessageDialog(new JFrame(), "Book is available and ready to be read"); 
